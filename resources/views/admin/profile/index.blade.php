...
@section('content')
     <div class="container">
         ...
         <div class="row">
             ...
             <div class="col-md-8">
                <form action="{{ action('Admin\ProfileControlle@index') }}" method="get">
                     ...
                     <table class="table table-dark">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <div>
                                         <a href="{{ action('Admin\ProfileControlle@edit', ['id' => $profile->id]) }}">編集</a>
                                     </div>
                                     <div>
                                         <a href="{{ action('Admin\ProfileControlle@delete', ['id' => $profile->id]) }}">削除</a>
                                     </div>
                                 </td>
                             </tr>
                             @endforeach
